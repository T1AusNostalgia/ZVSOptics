////////////////////////////////////////////////////////////////////
//DeRap: ZVS_optics\fx2\config.bin
...
class cfgVehicles
{
	...
	class VTR_fx2_scope: ItemOptics
	{
		scope = 2;
		displayName = "#FX2_00";
		descriptionShort = "#FX2_01";
		model = "ZVS_optics\fx2\fx2.p3d";
		...
		hiddenSelections[] = {"reddot","rmr","zbytek"};
		hiddenSelectionsTextures[] = {"","ZVS_optics\acogrmr\data\rmr.paa","ZVS_optics\fx2\data\fx2.paa"};
		hiddenSelectionsMaterials[] = {"","ZVS_optics\acogrmr\data\rmr.rvmat","ZVS_optics\fx2\data\material.rvmat"};
		...
		class DamageSystem
		{
			class GlobalHealth
			{
				...
				{
					hitpoints = 30;
					healthLevels[] = {{1.01,{"DZ\weapons\attachments\optics\data\lensglass_standard.rvmat","ZVS_optics\fx2\data\material.rvmat"}},{0.7,{}},{0.5,{"DZ\weapons\attachments\optics\data\lensglass_standard_damage.rvmat","ZVS_optics\fx2\data\material_damage.rvmat"}},{0.3,{}},{0.01,{"DZ\weapons\attachments\optics\data\lensglass_standard_destruct.rvmat","ZVS_optics\fx2\data\material_destruct.rvmat"}}};
				};
			};
		};
		class OpticsInfo
		{
			...
			discretefov[] = {"0.3926/8","0.3926/12"};
