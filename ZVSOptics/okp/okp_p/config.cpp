////////////////////////////////////////////////////////////////////
//DeRap: ZVS_optics\okp\okp_p\config.bin
...
class CfgPatches
{
	class VTR_optics_optics_okp7_p
	{
		units[] = {"VTR_okp7_rail"};
		weapons[] = {};
		requiredVersion = 0.1;
...
class cfgVehicles
{
	...
	class VTR_okp7_rail: ItemOptics
	{
		scope = 2;
		displayName = "#OKP1_00";
		descriptionShort = "#OPP1_01";
		model = "ZVS_optics\okp\okp_p\okp7_p.p3d";
